...
from utils.math import quat_multiply_numpy, quat_conjugate_numpy, yaw_quat
...
class UnitreeSdk2Bridge:
    ...
    def PublishLowState(self):
        ...
        # root_quat_b = quat_multiply_numpy(quat_conjugate_numpy(root_quat_yaw_w), root_quat_w)
